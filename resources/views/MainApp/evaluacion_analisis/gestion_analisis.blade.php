            ...
            <table class="table table-hover table-striped table-bordered">
                ...
                <tbody>
                    @foreach ($resultados as $resultado)
                        ...
                        @endphp
                        <tr class="table-{{ $estadoClase === 'danger' ? 'danger' : ($estadoClase === 'warning' ? 'warning' : '') }}">
                            ...
                            <td class="text-center">
                                @if($resultado->dias_restantes !== null)
                                    @if($resultado->dias_restantes < 0)
                                        <span class="text-danger">{{ abs($resultado->dias_restantes) }} días vencido</span>
                                    @else
                            ...
                            <td class="text-center">
                                <div class="btn-group" role="group">
                                    <button type="button" class="btn btn-sm btn-primary btn-editar-analisis"
                                            ...
                                            data-tipo="{{ $resultado->tabla_origen }}"
    ...
    <script>
        ...
        $(function(){
            ...
            if ($flashSuccess.length) {
                setTimeout(function(){ $flashSuccess.alert('close'); }, 4000);
            }
            if ($flashError.length) {
                setTimeout(function(){ $flashError.alert('close'); }, 4000);
            }
        });
        ...
        $(document).on('click', '.btn-editar-analisis', function() {
            ...
            $.get("{{ route('evaluacion_analisis.obtener_datos') }}", {
                ...
                if (response.success) {
                    generarFormularioEdicion(response.datos, tipo);
        ...
        function generarCamposAnalitica(datos) {
            ...
            html += '<input type="text" name="anio" class="form-control" value="' + (datos.anio || '') + '" readonly></div>';
            ...
            html += '<input type="text" name="precio_reducido_agua" class="form-control" value="' + (datos.precio_reducido_agua || '') + '"></div>';
            ...
            html += '<input type="text" name="tipo_referencia" class="form-control" value="' + (datos.tipo_referencia || '') + '"></div>';
            ...
            html += '<input type="text" name="descripcion_centro" class="form-control" value="' + (datos.descripcion_centro || '') + '"></div>';
            html += '<hr>';
            html += '</div>';
            html += '</div>';
            ...
            for (var i = 0; i < resultFields.length; i++) {
                ...
                html += '<label class="d-block font-weight-bold">' + field.charAt(0).toUpperCase() + field.slice(1) + '</label>';
        ...
        function generarCamposSuperficie(datos) {
            ...
            html += '<input type="text" name="semana" class="form-control" value="' + (datos.semana || '') + '" readonly></div>';
            html += '</div>';
            html += '<div class="form-row">';
            html += '<div class="form-group col-md-6"><label>Código Centro</label>';
            html += '<input type="text" name="codigo_centro" class="form-control" value="' + (datos.codigo_centro || '') + '"></div>';
            ...
            html += '<input type="text" name="provincia" class="form-control" value="' + (datos.provincia || '') + '"></div>';
            ...
            html += '<input type="text" name="codigo_referencia" class="form-control" value="' + (datos.codigo_referencia || '') + '"></div>';
            html += '</div>';
            html += '<div class="form-row">';
            html += '<div class="form-group col-md-6"><label>Referencias</label>';
            html += '<input type="text" name="referencias" class="form-control" value="' + (datos.referencias || '') + '"></div>';
            ...
            html += '<input type="text" name="aerobios_mesofilos_30c_valor" class="form-control" value="' + (datos.aerobios_mesofilos_30c_valor || '') + '"></div>';
            ...
            html += '<input type="text" name="enterobacterias_valor" class="form-control" value="' + (datos.enterobacterias_valor || '') + '"></div>';
            html += '<div class="form-group col-md-6"><label>Resultado</label>';
            ...
            html += '<input type="text" name="listeria_monocytogenes_valor" class="form-control" value="' + (datos.listeria_monocytogenes_valor || '') + '"></div>';
            html += '<div class="form-group col-md-6"><label>Resultado</label>';
            ...
            html += '<input type="text" name="accion_correctiva" class="form-control" value="' + (datos.accion_correctiva || '') + '"></div>';
            html += '<div class="form-group col-md-3"><label>Repetición N1</label>';
            html += '<input type="text" name="repeticion_n1" class="form-control" value="' + (datos.repeticion_n1 || '') + '"></div>';
            html += '<div class="form-group col-md-3"><label>Repetición N2</label>';
            html += '<input type="text" name="repeticion_n2" class="form-control" value="' + (datos.repeticion_n2 || '') + '"></div>';
            html += '</div>';
            html += '<div class="form-row">';
            html += '<div class="form-group col-md-6"><label>Proveedor ID</label>';
            html += '<input type="number" name="proveedor_id" class="form-control" value="' + (datos.proveedor_id || '') + '"></div>';
            html += '</div>';
        ...
        function generarCamposMicro(datos) {
            ...
            html += '<input type="date" name="fecha_toma_muestras" class="form-control" value="' + (datos.fecha_toma_muestras || '') + '"></div>';
            html += '<div class="form-group col-md-6"><label>Año</label>';
            html += '<input type="text" name="anio" class="form-control" value="' + (datos.anio || '') + '" readonly></div>';
            html += '</div>';
            html += '<div class="form-row">';
            ...
            html += '<input type="number" name="numero_muestra" class="form-control" value="' + (datos.numero_muestra || '') + '"></div>';
            html += '</div>';
            html += '<div class="form-row">';
            html += '<div class="form-group col-md-6"><label>Número factura</label>';
            html += '<input type="text" name="numero_factura" class="form-control" value="' + (datos.numero_factura || '') + '"></div>';
            html += '<div class="form-group col-md-6"><label>Código producto</label>';
            html += '<input type="text" name="codigo_producto" class="form-control" value="' + (datos.codigo_producto || '') + '"></div>';
            html += '</div>';
            html += '<div class="form-row">';
            html += '<div class="form-group col-md-6"><label>Nombre producto</label>';
            html += '<input type="text" name="nombre_producto" class="form-control" value="' + (datos.nombre_producto || '') + '"></div>';
            html += '<div class="form-group col-md-6"><label>Código proveedor</label>';
            html += '<input type="text" name="codigo_proveedor" class="form-control" value="' + (datos.codigo_proveedor || '') + '"></div>';
            html += '</div>';
            html += '<div class="form-row">';
            html += '<div class="form-group col-md-6"><label>Nombre proveedor</label>';
            html += '<input type="text" name="nombre_proveedor" class="form-control" value="' + (datos.nombre_proveedor || '') + '"></div>';
            html += '<div class="form-group col-md-6"><label>TE proveedor</label>';
            html += '<input type="text" name="te_proveedor" class="form-control" value="' + (datos.te_proveedor || '') + '"></div>';
            html += '</div>';
            html += '<div class="form-row">';
            ...
            html += '<input type="text" name="referencia" class="form-control" value="' + (datos.referencia || '') + '"></div>';
            ...
            html += '<input type="text" name="aerobiotico_valor" class="form-control" value="' + (datos.aerobiotico_valor || '') + '"></div>';
            html += '<div class="form-group col-md-6"><label>Resultado</label>';
            ...
            html += '<input type="text" name="entero_valor" class="form-control" value="' + (datos.entero_valor || '') + '"></div>';
            html += '<div class="form-group col-md-6"><label>Resultado</label>';
            ...
            html += '<input type="text" name="ecoli_valor" class="form-control" value="' + (datos.ecoli_valor || '') + '"></div>';
            html += '<div class="form-group col-md-6"><label>Resultado</label>';
            ...
            html += '<input type="text" name="salmonella_valor" class="form-control" value="' + (datos.salmonella_valor || '') + '"></div>';
            html += '<div class="form-group col-md-6"><label>Resultado</label>';
