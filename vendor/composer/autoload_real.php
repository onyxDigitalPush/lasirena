...
class ComposerAutoloaderInit705fb73970ef4b361891267ba219e830
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInit705fb73970ef4b361891267ba219e830::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequire705fb73970ef4b361891267ba219e830($fileIdentifier, $file);
        }
...
function composerRequire705fb73970ef4b361891267ba219e830($fileIdentifier, $file)
{
